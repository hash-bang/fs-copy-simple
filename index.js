...
* @param {string} src The source path. Must be a single file path
...
function copy(src, dst, callback) {
	async()
		...
		.then(function(next) {
			if (this.srcStat && this.srcStat.isDirectory() && this.dstStat && this.dstStat.isDirectory()) { // Dir -> Dir copy
